...
@section('breadcrumb', 'Nouveau Formateur')
@section('page-title', 'Créer un Nouveau Formateur')
...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('admin.formateurs.store') }}" method="POST" enctype="multipart/form-data">
          @csrf
          ...
          <div class="d-flex justify-content-end gap-2 mt-4">
            ...
            <button type="submit" class="btn btn-primary">Créer le Formateur</button>
          </div>
        </form>
      </div>
    </div>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (matieresSelect) {
      choicesMatieresInstance = new Choices(matieresSelect, {
        ...
        placeholder: true,
        placeholderValue: 'Sélectionnez d\'abord une classe',
    ...
    if (filiereSelect && filiereSelect.value) {
      filterClassesByFiliere();
      // Si les deux sont sélectionnés, charger les matières
      if (classeSelect && classeSelect.value && filiereSelect.value) {
        loadMatieres();
      }
    }
  });
