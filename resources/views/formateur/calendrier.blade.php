...
<body>
        ...
        <aside id="sidebar" class="sidebar-collapsed sidebar-bg text-white flex flex-col py-6">
            ...
            <nav class="flex-1 flex flex-col gap-6 w-full px-2">
                @php
                    ...
                    $isParametres = $currentRoute === 'formateur.parametres';
                @endphp
            ...
            <div class="w-full px-2 space-y-2 border-t border-gray-700/50 pt-4">
                <a href="{{ route('formateur.parametres') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg " style="transition: none !important; -webkit-transition: none !important; {{ $isParametres ? 'background-color: rgba(37, 99, 235, 0.2); border-left: 4px solid rgb(59, 130, 246);' : '' }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadEvents() {
                fetch('{{ route("formateur.calendrier.events") }}', {
                    method: 'GET',
                    headers: {
            ...
            // Cours dropdown functionality - identique au dashboard
        ...
        function loadEmploiDuTemps() {
            ...
            fetch('{{ route("formateur.emploi-du-temps") }}', {
                method: 'GET',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'Accept': 'application/json'
