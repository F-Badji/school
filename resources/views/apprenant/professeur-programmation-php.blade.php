...
<head>
    ...
    <title>Programmation en PHP - BJ Academie</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden bg-gray-50">
            ...
            <main class="flex-1 overflow-y-auto bg-white">
                <div class="max-w-7xl mx-auto px-6 py-6">
                    <!-- Page Title -->
                    <div class="mb-6 mt-8">
                        <h1 class="text-3xl font-bold text-gray-900">Programmation en PHP</h1>
                    </div>
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" value="Programmation en PHP" readonly class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-gray-50 cursor-not-allowed">
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div id="description-editor" style="height: 200px; pointer-events: none;">
                                        <div class="ql-editor text-base" data-placeholder="Entrer la description..." style="pointer-events: none; font-size: 16px; line-height: 1.6;">
                                            <p>Bonjour Étudiant ! 🎓 PHP est l'un des langages de programmation web les plus populaires. Je vous guiderai à travers les concepts fondamentaux jusqu'aux techniques avancées. Apprenez à créer des applications web dynamiques et performantes avec PHP dans mes cours complets 🚀</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                                        <div class="flex items-center gap-3 p-4 hover:bg-gray-50 transition-colors">
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                                ...
                                                <span class="flex-1 text-sm font-semibold text-gray-900">Semaine 1 - Débutant - Introduction à la programmation PHP</span>
                                        </button>
                                    ...
                                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                                        <div class="flex items-center gap-3 p-4 hover:bg-gray-50 transition-colors">
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                                ...
                                                <span class="flex-1 text-sm font-semibold text-gray-900">Semaine 2 - Débutant - Fondements de la programmation PHP</span>
                                        </button>
                                    ...
                                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                                        <div class="flex items-center gap-3 p-4 hover:bg-gray-50 transition-colors">
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                                ...
                                                <span class="flex-1 text-sm font-semibold text-gray-900">Semaine 3 - Débutant - Variables et types de données en PHP</span>
                                        </button>
                                    ...
                                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                                        <div class="flex items-center gap-3 p-4 hover:bg-gray-50 transition-colors">
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                                ...
                                                <span class="flex-1 text-sm font-semibold text-gray-900">Semaine 4 - Débutant - Fonctions et structures de contrôle</span>
                                        </button>
                                    ...
                                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                                        <div class="flex items-center gap-3 p-4 hover:bg-gray-50 transition-colors">
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                                ...
                                                <span class="flex-1 text-sm font-semibold text-gray-900">Semaine 5 - Débutant - Programmation orientée objet en PHP</span>
                                        </button>
                        ...
                        <div class="lg:col-span-1">
                            <div class="space-y-6">
                                ...
                                <div class="bg-white rounded-lg border border-gray-200 p-6">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Programmation en PHP</label>
