...
<head>
    ...
    <title>Tableau de bord - BJ Academie</title>
            ...
            <header class="bg-white border-b border-gray-200 px-8 py-6 relative z-10">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600">Bonjour, {{ $user->prenom ?? $user->name ?? 'Apprenant' }} 👋 Bienvenue sur votre espace d'apprentissage</p>
                    </div>
            ...
            <main class="flex-1 overflow-y-auto p-8 content-wrapper" style="background-color: rgba(249, 250, 251, 0.85);">
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="hero-banner mb-8">
                        <div class="hero-content">
                            ...
                            <p class="hero-subtitle">
                                Suivez votre progression, consultez vos notes et restez connecté avec votre formation
                            </p>
                            <p class="hero-description">
                                Accédez à tous vos cours, devoirs, examens et événements en un seul endroit. Votre réussite est notre priorité.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="stat-card">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Absent</div>
                                    <div class="text-4xl font-bold text-gray-900 mb-2">{{ $totalAbsents ?? 0 }}</div>
                                    <div class="text-xs text-gray-500">Total absents</div>
                        </div>
                        ...
                        <div class="stat-card">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Événements</div>
                                    <div class="text-4xl font-bold text-gray-900 mb-2">{{ $tousEvenements->count() ?? 0 }}</div>
                        ...
                        <div class="stat-card">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Devoir</div>
                                    <div class="text-4xl font-bold text-gray-900 mb-2">{{ $totalDevoirsDisponibles ?? 0 }}</div>
                                    <div class="text-xs text-gray-500">Total des devoirs</div>
                                </div>
                        ...
                        <div class="stat-card">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Examen</div>
                                    <div class="text-4xl font-bold text-gray-900 mb-2">{{ $totalExamensDisponibles ?? 0 }}</div>
                                    <div class="text-xs text-gray-500">Total des examens</div>
                                </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                        ...
                        <div class="lg:col-span-2 chart-card">
                            <div class="flex items-center justify-between mb-6">
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900 mb-1">Performance académique</h2>
                                    <p class="text-sm text-gray-500">Évolution sur les 10 derniers mois</p>
                                </div>
                        ...
                        <div class="chart-card">
                            <div class="flex items-center justify-between mb-6">
                                <div>
                                    <h2 class="text-xl font-bold text-gray-900 mb-1">Événements à venir</h2>
                                    <p class="text-sm text-gray-500">{{ ($tousEvenements->count() ?? 0) }} événements</p>
                                </div>
                            </div>
                            <div class="space-y-3 max-h-[320px] overflow-y-auto">
                                @php
                                  $evenementsAvenirList = $tousEvenements ?? collect([]);
                                @endphp
                    ...
                    <div class="chart-card mb-8">
                        <div class="flex items-center justify-between mb-6">
                            <h2 class="text-xl font-bold text-gray-900">Mes camarades de classe</h2>
                            <div class="flex items-center gap-2">
                        ...
                        <div id="apprenantsContainer" class="flex gap-4 overflow-x-auto scrollbar-hide pb-4" style="scroll-behavior: smooth;">
                            @php
                              $autresApprenantsList = $autresApprenants ?? collect([]);
                            @endphp
                            @forelse($autresApprenantsList as $apprenant)
                            <div class="apprenant-card flex-shrink-0 w-64 bg-white border border-gray-200 rounded-xl p-4 hover:shadow-lg transition-shadow">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <a href="{{ route('apprenant.messages') }}?user={{ $apprenant->id }}" class="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm font-medium text-gray-700 transition-colors">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
                                        </svg>
                                        Chat
                            ...
                            <div class="w-full text-center py-8 text-gray-500">
                                <p>Aucun autre apprenant trouvé dans votre classe.</p>
                            </div>
                            @endforelse
                        </div>
                    </div>
                        ...
                        <div class="chart-card">
                            <div class="flex items-center justify-between mb-6">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">{{ $tousEvenements->count() ?? 0 }} événements ce mois</p>
                                </div>
                                            <div class="flex items-center gap-2">
                            ...
                            <div class="grid grid-cols-7 gap-2">
                                ...
                                @php
                                    ...
                                    $eventDates = [];
                                    if(isset($tousEvenements)) {
                                        foreach($tousEvenements as $event) {
                        ...
                        <div class="chart-card">
                            ...
                            <div class="space-y-4">
                                <div class="p-5 bg-gray-50 rounded-xl border border-gray-200">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-900">Devoirs</p>
                                                <p class="text-xs text-gray-500 mt-0.5">{{ $totalDevoirsDisponibles ?? 0 }} {{ ($totalDevoirsDisponibles ?? 0) > 1 ? 'devoirs' : 'devoir' }}</p>
                                            </div>
                                    </div>
                                ...
                                <div class="p-5 bg-gray-50 rounded-xl border border-gray-200">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p class="text-sm font-semibold text-gray-900">Examens</p>
                                                <p class="text-xs text-gray-500 mt-0.5">{{ $totalExamensDisponibles ?? 0 }} {{ ($totalExamensDisponibles ?? 0) > 1 ? 'examens' : 'examen' }}</p>
                                            </div>
                                    </div>
                                        <div class="text-right">
                                            <p class="text-2xl font-bold text-gray-900">{{ $totalExamensDisponibles ?? 0 }}</p>
                                    </div>
                                    </div>
                                    </div>
                                ...
                                <div class="p-5 bg-gray-50 rounded-xl border border-gray-200">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4">
                                            <div class="w-12 h-12 rounded-xl flex items-center justify-center" style="background: linear-gradient(135deg, #f3e8ff 0%, #e9d5ff 100%); color: #9333ea;">
                                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                                                </svg>
                                        </div>
                                            <div>
                                                <p class="text-sm font-semibold text-gray-900">Quiz complétés</p>
                                                <p class="text-xs text-gray-500 mt-0.5">{{ $totalQuiz ?? 0 }} {{ ($totalQuiz ?? 0) > 1 ? 'quiz' : 'quiz' }}</p>
                                    </div>
                                </div>
                                        <div class="text-right">
    ...
    <script>
        ...
        const performanceChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Devoirs',
                    data: performanceData.map(d => d.devoirs),
                    borderColor: '#065b32',
                    ...
                    label: 'Examens',
                    data: performanceData.map(d => d.examens),
                    borderColor: '#2563eb',
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function(context) {
                                ...
                                const noteSur20 = context.parsed.y.toFixed(2);
                                label += noteSur20 + '/20';
                                return label;
                            }
                        }
